...
public class WebSocketServer 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        try
        {
            webserverPort = Integer.parseInt(configurationProperties.getProperty("webserverPort"));
        }
        catch(Exception e)
        {
        ...
        try
        {
            httpsWebserverPort = Integer.parseInt(configurationProperties.getProperty("httpsWebserverPort"));
        }
        catch(Exception e)
        {
            System.out.println("webserver port not specified in GatewayConfiguration.properties, using default of " + DEFAULT_WEBSERVER_PORT);
       ...
       // it finds a match.
        ...
        int port = Integer.parseInt(configurationProperties.getProperty("disPort"));
        String mcastString = configurationProperties.getProperty("multicastAddress");
        MulticastSocket s = DisSocketFactory.getDisSocket(port, mcastString); // bcast if null
        
        DisNative listener;
        
        // No mcast group specified in configurationProperties file? Use bcast.
        if(mcastString == null)
        {
